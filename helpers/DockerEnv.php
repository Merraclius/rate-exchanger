 ...
 * DockerEnv
 *
 * This is a utility class that helps to load Yii2, initialize
...
class DockerEnv
{
     ...
     *
     * @param array $_files a configuration file with overrides for the console configuration.
     ...
     *  - the $dsn parameter
     *
     * @param string $dsn the dsn to return if no env var is set and not in testing mode. Default is 'mongodb://developer:password@localhost:27017/currency_exchange'.
